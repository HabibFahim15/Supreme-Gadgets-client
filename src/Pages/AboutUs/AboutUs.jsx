...
const AboutUs = () => {
  return (
    <section>
      <div class="bg-white dark:bg-base-100  pb-6 sm:pb-8 lg:pb-12">
  <div class="mx-auto max-w-screen-2xl px-4 md:px-8">
    ...
    <section class="flex flex-col justify-between gap-6 sm:gap-10 md:gap-16 lg:flex-row">
      ...
      <div class="flex flex-col justify-center sm:text-center lg:py-12 lg:text-left xl:w-5/12 xl:py-24">
        ...
        <h1 class="mb-8 text-4xl font-bold  sm:text-5xl md:mb-12 md:text-6xl">Revolutionary way to build the web</h1>
      ...
      <div className="bg-white dark:bg-base-100 py-6 sm:py-8 lg:py-12">
        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
          <h2 className="mb-4 text-center text-2xl font-bold  md:mb-8 lg:text-3xl">Trusted by the best</h2>
      ...
      <div className="bg-white dark:bg-base-100 py-6 sm:py-8 lg:py-12">
        <div className="mx-auto max-w-screen-xl px-4 md:px-8">
          ...
          <div className="mb-10 md:mb-16">
            <h2 className="mb-4 text-center text-2xl font-bold  md:mb-6 lg:text-3xl">Our Team by the numbers</h2>
      ...
      <div className="bg-white dark:bg-base-100 py-6 sm:py-8 lg:py-12">
        <div className="mx-auto max-w-screen-xl px-4 md:px-8">
          ...
          <div className="mb-10 md:mb-16">
            <h2 className="mb-4 text-center text-2xl font-bold  md:mb-6 lg:text-3xl">Meet our Team</h2>
      ...
      <div className="bg-white dark:bg-base-100 py-6 sm:py-8 lg:py-12">
        <div className="mx-auto max-w-screen-xl px-4 md:px-8">
          <h2 className="mb-8 text-center text-2xl font-bold  md:mb-12 lg:text-3xl">What others say about us</h2>
        ...
        <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
          <div className="flex flex-col items-center rounded-lg bg-gray-100 p-4 sm:p-8">
            ...
            <form className="mb-3 flex w-full max-w-md gap-2 sm:mb-5">
              <input placeholder="Email" className="bg-gray-white w-full flex-1 rounded border border-gray-300 px-3 py-2  placeholder-gray-400 outline-none ring-indigo-300 transition duration-100 focus:ring" />
