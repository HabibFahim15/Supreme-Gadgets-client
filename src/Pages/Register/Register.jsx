    ...
    <form onSubmit={handleRegister} className="mx-auto max-w-lg rounded-lg border dark:border-gray-700">
      <div className="flex flex-col gap-4 p-4 md:p-8">
        ...
        <div>
          ...
          <input name="number" className="w-full rounded border bg-gray-50 dark:bg-gray-800 px-3 py-2 text-gray-800 dark:text-gray-200 outline-none ring-indigo-300 transition duration-100 focus:ring" />
        </div>
        ...
        <div>
          ...
          <input type="password" name="password" className="w-full rounded border bg-gray-50 dark:bg-gray-800 px-3 py-2 text-gray-800 dark:text-gray-200 outline-none ring-indigo-300 transition duration-100 focus:ring" />
        </div>
