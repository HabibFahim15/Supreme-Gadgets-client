  ...
  <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
    ...
    <div className="mx-auto max-w-lg rounded-lg border dark:border-gray-700">
        ...
        <div>
          ...
          <input required name="name" className="w-full rounded border bg-gray-50 dark:bg-gray-800 px-3 py-2 text-gray-800 dark:text-gray-200 outline-none ring-indigo-300 transition duration-100 focus:ring" />
        </div>
        <div>
          <label for="name" className="mb-2 inline-block text-sm text-gray-800 dark:text-gray-200 sm:text-base">Photo</label>
          <input required name="photo" className="w-full rounded border bg-gray-50 dark:bg-gray-800 px-3 py-2 text-gray-800 dark:text-gray-200 outline-none ring-indigo-300 transition duration-100 focus:ring" />
        </div>

        <div>
          <label for="number" className="mb-2 inline-block text-sm text-gray-800 dark:text-gray-200 sm:text-base">Phone Number</label>
          <input required name="number" className="w-full rounded border bg-gray-50 dark:bg-gray-800 px-3 py-2 text-gray-800 dark:text-gray-200 outline-none ring-indigo-300 transition duration-100 focus:ring" />
        </div>

        <div>
          <label for="email" className="mb-2 inline-block text-sm text-gray-800 dark:text-gray-200 sm:text-base">Email</label>
          <input required name="email" className="w-full rounded border bg-gray-50 dark:bg-gray-800 px-3 py-2 text-gray-800 dark:text-gray-200 outline-none ring-indigo-300 transition duration-100 focus:ring" />
        </div>

        <div>
          <label for="password" className="mb-2 inline-block text-sm text-gray-800 dark:text-gray-200 sm:text-base">Password</label>
          <input required type="password" name="password" className="w-full rounded border bg-gray-50 dark:bg-gray-800 px-3 py-2 text-gray-800 dark:text-gray-200 outline-none ring-indigo-300 transition duration-100 focus:ring" />
        </div>
        ...
        <div className="relative flex items-center justify-center">
          ...
          <span className="relative bg-white dark:bg-base-100 px-4 text-sm text-gray-400 dark:text-gray-500">Or register with social</span>
        </div>
      ...
      <div className="flex items-center justify-center bg-gray-100 dark:bg-gray-800 p-4">
        <Link to={'/login'} className="text-center text-sm text-gray-500 dark:text-gray-400">Already have an account? <a href="#" className="text-indigo-500 transition duration-100 hover:text-indigo-600 active:text-indigo-700 dark:hover:text-indigo-400">Login</a></Link>
      </div>
    </div>
  </div>
</div>
